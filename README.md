...
**Figure 2** Attention weight heatmap generated by MGMA-PPIS for Chain A in 2yc2 protein. 

![Figure 3](Figures/Figure_3_1.png)

**Figure 3** The running time of AGAT-PPIS, GHGPR-PPIS, and MGMA-PPIS on the validation dataset. 

![Figure S1](Figures/Figure_S1_1.png)

**Figure S1** ROC curves of MGMA and other two comparation methods on Test_60 dataset 

![Figure S2](Figures/Figure_S2_1.png)
